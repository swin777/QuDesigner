define(["dojo/_base/declare",
	...
	return declare("ashDrawEx.ExCanvas", ashDraw.Canvas, {
		...
		onMouseOver : function(x, y, figure){
	  	...
	  	createFigure : function(nodeId, clsName, nodeType) {
			...
			if("SVG" == nodeType) {
				...
				//figure = eval("new " + clsName + "();");
				figure = new Function("return new " + clsName + "()")();
			}
			return figure;
		},
	    ...
	    onDrop : function(droppedDomNode, x, y){
			...
			var clsName = $(droppedDomNode).data("shape");
			var nodeType = $(droppedDomNode).data("type");
			var figure = this.createFigure(nodeId, clsName, nodeType);
...
//	     	
	    	...
	    	QuDesigner.app.eventbus.dispatch('autoLayout');
	    },
